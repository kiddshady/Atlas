...
const ROOT = process.env.ATLAS_DATA || defaultRoot();
...
const DEFAULT_SETTINGS = {
  schema: SCHEMA,
  /** Las carpetas donde viven los proyectos: cada subcarpeta directa es uno. */
  raices: ['C:\\tools', 'S:\\tools'],
  /** Subcarpetas de las raíces que no son proyectos y no vale la pena medir. */
  excluir: ['node_modules', 'temp', 'backups'],
  /** Volver a escanear al abrir. Si no, se muestra el último escaneo. */
  escanearAlAbrir: true,
  /** Por qué se dimensiona el mapa: 'total' o 'codigo'. */
  medida: 'total',
};
